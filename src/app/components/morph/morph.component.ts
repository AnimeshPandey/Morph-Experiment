...
import scrollMonitor from '../../../assets/js/scrollMonitor.js';
...
export class MorphComponent implements OnInit {
  ...
  ngOnInit() {
    ...
    const initShapeLoop = function (pos = 0) {
      pos = pos || 0;
    ...
    const createScrollWatchers = function () {
      DOM.contentElems.forEach((el, pos) => {
        const scrollElemToWatch = pos != undefined ? DOM.contentElems[pos] : DOM.footer;
